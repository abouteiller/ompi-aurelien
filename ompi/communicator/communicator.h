...
#define OMPI_COMM_REPORT_ASYNC          0x00000040
#define OMPI_COMM_UNIFORM_CREATE        0x00000080
#define OMPI_COMM_UNIFORM_COLL          0x00000100
...
#if OPAL_ENABLE_FT_MPI
#define OMPI_COMM_CHECK_ASSERT_REPORT_LOCAL(comm) (!OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_REPORT_GROUP | OMPI_COMM_REPORT_GLOBAL))
#define OMPI_COMM_CHECK_ASSERT_REPORT_GROUP(comm)   OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_REPORT_GROUP)
#define OMPI_COMM_CHECK_ASSERT_REPORT_GLOBAL(comm)  OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_REPORT_GLOBAL)
#define OMPI_COMM_CHECK_ASSERT_REPORT_ASYNC(comm)   OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_REPORT_ASYNC)
#define OMPI_COMM_CHECK_ASSERT_UNIFORM_CREATE(comm) OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_UNIFORM_CREATE)
#define OMPI_COMM_CHECK_ASSERT_UNIFORM_COLL(comm)   OMPI_COMM_CHECK_ASSERT(comm, OMPI_COMM_UNIFORM_COLL)
#endif /* OPAL_ENABLE_FT_MPI */
