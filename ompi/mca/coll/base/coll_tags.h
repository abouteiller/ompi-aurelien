...
#define MCA_COLL_BASE_TAG_HCOLL_BASE (MCA_COLL_TAG_NONBLOCKING_END - 1)
#define MCA_COLL_BASE_TAG_HCOLL_END  (MCA_COLL_TAG_HCOLL_BASE + (MCA_COLL_BASE_TAG_NONBLOCKING_END - MCA_COLL_BASE_TAG_NONBLOCKING_BASE))
